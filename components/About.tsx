          ...
          >
            <div className={`relative ${imageAspect} rounded-3xl overflow-hidden group shadow-2xl border border-white/10 bg-[#0A0A0A]`}>
              ...
              <Image
                ...
                className={`${
                  objectFit === "cover" ? "object-cover object-[center_10%]" : "object-contain"
                } ${zoom ? "scale-125 group-hover:scale-110" : "scale-100 group-hover:scale-[1.02]"} w-full h-full filter grayscale group-hover:grayscale-0 transition-all duration-1000 ease-out`}
                height={1200}
                src={displayImage}
                width={1000}
              />
