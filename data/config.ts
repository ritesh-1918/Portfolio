export const siteConfig = {
  ...
  about: {
    badge: "About Me",
    title: "AI & Hardware Engineer | Entrepreneur",
    description: [
  ...
  education: {
    ...
    description: "A timeline of my formal education and qualifications.",
  },
  services: {
    badge: "Services",
